;;; packages.el --- aya-org layer packages file for Spacemacs.
;;
...
;; added to `aya-org-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `aya-org/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `aya-org/pre-init-PACKAGE' and/or
;;   `aya-org/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst aya-org-packages
  '()
  "The list of Lisp packages required by the aya-org layer.
